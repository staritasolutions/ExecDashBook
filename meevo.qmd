...
Take Home % is the percentage of clients who were serviced that also bought take home. The calculation is done in the following manner:
$$\frac{\texttt{Total Serviced Guests That Bought Take Home}}{\texttt{Total Guests Serviced}}$$

**Recreation in Meevo:** A comparable number can be found in the MR090 report. This number, however, will be different because it is simply the unique number of guests who bought retail divided the total number of unique guest visits over the date range. There are a couple fundamental differences in Meevo's logic:

1. A guest is only counted once in the date range
2. A guest who bought retail but was not serviced is counted in the numerator of the calculation

Because the tracking of Take Home % is done to evaluate the art of selling product to clients who are being serviced (not clients who walk in to just purchase product), we believe that the way we calculate this number is more appropriate. 
