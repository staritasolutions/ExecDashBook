...
**Recreation in Meevo:** Number can be found in an MA225 report as 
$$\texttt{Service} - \texttt{Refunds}$$

*North Star Group Only:* Number can be found in an MA225 report as 
$$\texttt{Service} + \texttt{Gift Cards} + \texttt{Mem. EFTs} - \texttt{All Corresponding Refunds}$$
...
This is the average number of bottles sold per guest serviced. This is calculated by taking the total number of bottles sold and dividing it by the number of guests serviced, calculated as described above: 
$$\frac{\texttt{Total Bottles Sold}}{\texttt{Total Guests Serviced}}$$
